...
// mise [dotfiles] symlink-each installs each source file as a symlink. Node/Bun
// then resolve packages from the realpath (the dotfiles tree), not ~/.pi. If
// npm install ran in the live target, point the source tree at that node_modules.
